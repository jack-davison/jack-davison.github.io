...
@fig-themes reveals that (unsurprisingly) festive classes are all before January, but the other three common themes are spaced out regularly throughout the year.

```{r}
#| label: fig-themes
#| fig-cap: "Distribution of common classes throughout the year."
pasta |>
  tidytext::unnest_tokens(word, name) |>
